# RSpec helper that will direct log output to a StringIO appender. Log lines
# can be read from this IO destination during tests.
#
# Through log messages you can
